...
#barb 5, paladin 3, great sword, GWF, GWM, rage, reckless attack, sacred weapon, frenzy
builds = {
    "barb 5, paladin 3":
        
resolve_turn_attacks(attack(d(6).ge(3).times(2)).prof(3).amod(4).adv().gwm().attbon(3).dmgbon(2).times(3),
                             armor_class=AC)
}

print(builds["barb 5, paladin 3"])
"""
plot_builds(builds)
